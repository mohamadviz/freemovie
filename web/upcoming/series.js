...
const apiUrl = `https://api.themoviedb.org/3/tv/on_the_air?api_key=${apiKey}&language=fa-IR&page=`;
const imageCache = {};
...
async function fetchSeries(page, isInitial = false) {
    if (isLoading) return;
    isLoading = true;
    const container = document.getElementById('upcoming-tv');
    ...
    try {
        ...
        console.error('خطا در دریافت داده‌ها (سریال‌ها):', error);
